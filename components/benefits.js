...
export default function Benefits(props) {
  ...
  return (
    <>
      <Container className="flex flex-wrap mb-16 lg:mb-20 lg:gap-10 lg:flex-nowrap ">
        <div
        ...
        <div
          ...
          <div>
            <div className={`flex flex-col w-full ${data.title ? "mt-4" : "hidden"}`}>
            ...
            <div className={`w-full ${data.title ? "lg:mt-5" : ""} mt-5 lg:mt-0 space-y-8`}>
